...
r.prototype.connect = function( options, callback = error => error && console.error( error ) ) {
...
r.prototype.branch = function( predicate ) {
    var _len = arguments.length;
    var _args = new Array( _len );
    for ( var _i = 0; _i < _len; _i++ ) {
        _args[ _i ] = arguments[ _i ];
...
r.prototype.reconfigure = function() {
...
r.prototype.rebalance = function() {
